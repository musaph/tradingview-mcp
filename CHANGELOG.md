...
- Bumped default `risk_free_rate` from 0.02 (2%) to 0.045 (4.5%) — reflects current US money market / T-bill yields more accurately; using the old 2% default was inflating Sharpe ratios
